...
mix_pt = [
    ("O Clássico da Sofia", 70, 69.90, 26.50, "1 Frango recheado inteiro (~1,4kg assado), farofa artesanal crocante (250g), maionese caseira tradicional de batata (300g). Serve 3-4 pessoas."),
    ...
    ("Dueto Sofia", 35, 94.90, 36.00, "Meio frango assado dourado + 500g de Costelinha de porco marinada em ervas, batatas rústicas douradas (300g) e farofa da casa (200g). Serve 3-4 pessoas."),
    ("Kit Churrasco Família", 20, 169.90, 68.00, "1 Frango recheado inteiro + 700g de Costela bovina no bafo + 4 Linguiças toscanas artesanais grelhadas, maionese grande (500g), farofa grande (400g) e pães de alho (4 un). Serve 5-6 pessoas."),
]

mix_es = [
    ("El Clásico de Sofia", 70, 69.90, 26.50, "1 Pollo relleno entero (~1,4kg asado), farofa artesanal crocante (250g), mayonesa casera tradicional de patata (300g). Rinde 3-4 personas."),
    ("Costilla Suprema", 35, 119.90, 48.00, "1kg de Costilla vacuna premium asada lentamente al vapor por 6 horas, mandioca a la manteca (300g), vinagreta fresca y farofa de la casa (250g). Rinde 4 personas."),
    ("Dueto Sofia", 35, 94.90, 36.00, "Medio pollo asado dorado + 500g de Costilla de cerdo marinada en hierbas, patatas rústicas doradas (300g) y farofa de la casa (200g). Rinde 3-4 personas."),
    ("Kit Parrillero Familia", 20, 169.90, 68.00, "1 Pollo relleno entero + 700g de Costilla vacuna braseada + 4 Chorizos criollos artesanales a la parrilla, mayonesa grande (500g), farofa grande (400g) y panes de ajo (4 un). Rinde 5-6 personas."),
]
...
print('Full builder script setup complete.')
